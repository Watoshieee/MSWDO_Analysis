...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .prog-mini .bar  { width: 60px; height: 6px; background: #e2e8f0; border-radius: 6px; overflow: hidden; }
        .prog-mini .fill { height: 100%; background: var(--primary-gradient); border-radius: 6px; }
        .prog-mini .pct  { font-size: 0.7rem; font-weight: 700; color: var(--primary-blue); min-width: 28px; }
