...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .form-card-header { background: var(--primary-gradient); color: white; padding: 16px 22px; font-size: 0.95rem; font-weight: 700; }
        ...
        .list-card-header span { font-size: 0.95rem; font-weight: 700; }
