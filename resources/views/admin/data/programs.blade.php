...
<head>
    ...
    <title>Program Data - {{ $municipality->name }}</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="bi bi-heart"></i> Program Data - {{ $municipality->name }}
            </a>
                    ...
                    <div class="modal fade" id="editModal{{ $program->id }}" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('admin.data.programs.update', $program->id) }}">
                                    @csrf
    ...
    <div class="modal fade" id="createModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('admin.data.programs.create') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Program Type</label>
    ...
    <script>
        function deleteProgram(id) {
            if (confirm('Are you sure you want to delete this program data?')) {
                ...
                form.method = 'POST';
                form.action = '/admin/data/programs/' + id + '/delete';
