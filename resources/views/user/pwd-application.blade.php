...
<head>
    ...
    <title data-en="PWD Application Guide - MSWDO" data-tl="Gabay sa PWD Application - MSWDO">PWD Application Guide -
        MSWDO</title>
    ...
    <style>
        ...
        *,
        ...
        .tl-item.active:not(:last-child)::before {
            background: linear-gradient(to bottom, #86efac, var(--border-light));
        }
        ...
        .tl-item.active .tl-dot {
            ...
            border-color: var(--primary-blue);
            color: white;
            box-shadow: 0 4px 12px rgba(44, 62, 143, .25);
        }
        ...
        .mon-btn-yellow:hover {
            transform: translateY(-1px);
            box-shadow: 0 6px 16px rgba(253, 185, 19, .35);
        }
        ...
        .monitor-progress-card .mp-label {
            font-size: .72rem;
            font-weight: 700;
            color: #64748b;
            text-transform: uppercase;
        ...
        .monitor-progress-card .mp-fill {
            height: 100%;
            background: var(--secondary-yellow);
            border-radius: 4px;
        }

        .monitor-progress-card .mp-text {
            font-size: .78rem;
            color: var(--primary-blue);
            font-weight: 700;
            margin-top: 6px;
...
<body>
    ...
    <section class="hero-banner compact" id="hero-banner">
        <div class="container">
            <div class="hero-inner">
                ...
                <h1 id="hero-title" data-en="PWD Application" data-tl="PWD Application">PWD Application
                </h1>
                <div class="hero-divider"></div>
                <p class="hero-sub" id="hero-sub"
                    data-en="Follow each step below to apply for your PWD ID, submit requirements online, and verify your membership all in one guided flow."
                    data-tl="Sundin ang bawat hakbang sa ibaba para mag-apply ng PWD ID, magsumite ng mga kinakailangan online, at i-verify ang iyong membership  lahat sa isang gabay na daloy.">
                    Follow each step below to apply for your PWD ID, submit requirements online, and verify your
                    membership all in one guided flow.
                </p>
            </div>
        </div>
    </section>
            ...
            <div id="pwd-monitor-view" style="display:none;">
                <div class="monitor-card">
                    <div class="monitor-header">
                        <div
                            ...
                            <div>
                                <h2 data-en="Your PWD Application" data-tl="Iyong PWD Application">Your PWD Application
                                </h2>
                                <p data-en="Track your application progress, upload documents, and stay updated."
                                    data-tl="Subaybayan ang progress ng iyong aplikasyon, mag-upload ng dokumento, at manatiling updated.">
                                    Track your application progress, upload documents, and stay updated.</p>
                            </div>
                    ...
                    @if(!empty($isPwdBeneficiary))
                        <div class="monitor-body" style="padding:24px 32px;">
                            <div class="info-card mb-0">
                                ...
                                <div class="ic-body">Naka-register ka na bilang PWD beneficiary. Re-application is disabled.
                                    Para sa updates o concerns, bumisita sa MSWDO office.</div>
                            </div>
                        </div>
                    @else
                        ...
                        <div class="monitor-stats-bar">
                            <div class="monitor-stat">
                                <div class="sv">{{ $approvedR }}</div>
                                <div class="sl" data-en="Approved" data-tl="Approved">Approved</div>
                            </div>
                            <div class="monitor-stat">
                                <div class="sv">{{ $pendingR + $inReviewR }}</div>
                                <div class="sl" data-en="In Review" data-tl="In Review">In Review</div>
                            </div>
                            <div class="monitor-stat">
                                <div class="sv">{{ $rejectedR }}</div>
                                <div class="sl" data-en="Rejected" data-tl="Rejected">Rejected</div>
                            </div>
                            <div class="monitor-stat">
                                <div class="sv">{{ max(0, $totalR - $uploadedCount) }}</div>
                                <div class="sl" data-en="Missing" data-tl="Kulang">Missing</div>
                            </div>
                        </div>
                            ...
                            <div class="monitor-layout">
                                <aside class="monitor-aside">
                                    <div class="monitor-progress-card">
                                        <div class="mp-label" data-en="Overall Progress" data-tl="Kabuuang Progress">Overall
                                            Progress</div>
                                        <div class="mp-bar">
                                            <div class="mp-fill" style="width:{{ $pctR }}%;"></div>
                                        </div>
                                    ...
                                    <div class="monitor-actions">
                                        ...
                                        <a href="https://pwd.doh.gov.ph/tbl_pwd_id_verificationlist.php" target="_blank"
                                            class="mon-btn mon-btn-outline">
                                            <span data-en="Open PWD Verifier" data-tl="Buksan ang PWD Verifier">Open PWD
                                                Verifier</span>
                                        </a>
                                        <a href="https://pwd.doh.gov.ph/downloads/PRPWD-APPLICATION_FORM.pdf"
                                            target="_blank" class="mon-btn mon-btn-yellow">
                                            <span data-en="Download PRPWD Form" data-tl="I-download ang PRPWD Form">Download
                                                PRPWD Form</span>
                                        </a>
                                    </div>
                                </aside>
                                ...
                                <div class="monitor-main">
                                    <div class="section-label" data-en="Your Uploaded Requirements"
                                        data-tl="Iyong mga Na-upload na Requirements">Your Uploaded Requirements</div>
                                    <div class="section-hint"
                                        data-en="Upload or replace documents below. The admin will review each submission."
                ...
                <div class="text-center py-2">
                    <a href="{{ route('user.dashboard') }}" class="back-btn d-inline-flex"
                        style="font-size:.92rem;padding:12px 28px;background:var(--primary-gradient);">
            ...
            <div id="pwd-wizard-view">
                <div class="wizard-card">
                    <div class="wizard-top">
                        <h2 id="wizard-step-title" data-en="Step 1 — Overview"
                            data-tl="Hakbang 1 — Pangkalahatang-ideya">Step 1 — Overview</h2>
                        <p id="wizard-step-desc" data-en="Learn what you need and how this wizard works."
                            data-tl="Alamin ang mga kailangan mo at kung paano gumagana ang wizard na ito.">Learn what
                            you need and how this wizard works.</p>
                    ...
                    <div class="wizard-steps" id="wizard-steps-nav" role="tablist">
                        <button type="button" class="wiz-step active" data-step="0" data-en="Overview"
                            data-tl="Pangkalahatan">
                            <span class="wiz-step-circle">1</span>
                            <span class="wiz-step-label" data-en="Overview" data-tl="Pangkalahatan">Overview</span>
                        </button>
                        <button type="button" class="wiz-step" data-step="1" data-en="How to Apply"
                            data-tl="Paano Mag-apply">
                            <span class="wiz-step-circle">2</span>
                            <span class="wiz-step-label" data-en="How to Apply" data-tl="Paano Mag-apply">How to
                                Apply</span>
                        </button>
                        <button type="button" class="wiz-step" data-step="2" data-en="Form & Office"
                            data-tl="Form at Opisina">
                            <span class="wiz-step-circle">3</span>
                            <span class="wiz-step-label" data-en="Form & Office" data-tl="Form at Opisina">Form &
                                Office</span>
                        </button>
                        @if(empty($isPwdBeneficiary))
                    ...
                    <div class="wizard-body">
                        ...
                        <div class="wizard-panel active" data-panel="overview">
                            <div class="panel-heading" data-en="Welcome to the PWD Application Process"
                                data-tl="Maligayang Pagdating sa Proseso ng PWD Application">Welcome to the PWD
                                Application Process</div>
                            <div class="panel-sub"
                                data-en="This wizard walks you through everything — from downloading the official form to uploading your documents and verifying your PWD membership."
                                data-tl="Gagabayan ka ng wizard na ito sa lahat — mula sa pag-download ng opisyal na form hanggang sa pag-upload ng mga dokumento at pag-verify ng iyong PWD membership.">
                                This wizard walks you through everything — from downloading the official form to
                                uploading your documents and verifying your PWD membership.
                            </div>

                            <div class="overview-grid mb-4">
                                <div class="overview-tile">
                                    <div class="ot-num">5</div>
                                    <div class="ot-label" data-en="Official steps to get your PWD ID"
                                        data-tl="Opisyal na hakbang para makuha ang PWD ID">Official steps to get your
                                        PWD ID</div>
                                </div>
                                <div class="overview-tile">
                                    <div class="ot-num">4</div>
                                    <div class="ot-label" data-en="Documents you can upload online"
                                        data-tl="Mga dokumentong maaaring i-upload online">Documents you can upload
                                        online</div>
                                </div>
                                <div class="overview-tile">
                                    <div class="ot-num">1</div>
                                    <div class="ot-label" data-en="Official DOH verification portal"
                                        data-tl="Opisyal na DOH verification portal">Official DOH verification portal
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wiz-2col">
                                <div class="info-card yellow mb-0">
                                    <div class="ic-title" data-en="What you'll need" data-tl="Mga kailangan mo">What
                                        you'll need</div>
                                    <div class="ic-body">
                                        <ul style="margin:0;padding-left:18px;line-height:2;">
                                            <li data-en="Completed PRPWD Application Form"
                                                data-tl="Nakumpletong PRPWD Application Form">Completed PRPWD
                                                Application Form</li>
                                            <li data-en="Certificate of Disability (original + 1 photocopy)"
                                                data-tl="Sertipiko ng Kapansanan (orihinal + 1 photocopy)">Certificate
                                                of Disability (original + 1 photocopy)</li>
                                            <li data-en="Two (2) recent 1×1 ID pictures"
                                                data-tl="Dalawang (2) bagong 1×1 ID na larawan">Two (2) recent 1×1 ID
                                                pictures</li>
                                            <li data-en="Valid government-issued ID"
                                                data-tl="Valid na ID na inilabas ng gobyerno">Valid government-issued ID
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div>
                                    @if(!empty($isPwdBeneficiary))
                                        <div class="info-card mb-0">
                                            <div class="ic-title">PWD Beneficiary Status</div>
                                            <div class="ic-body">Naka-register ka na bilang PWD beneficiary. Maaari mo pa
                                                ring basahin ang gabay, ngunit naka-disable ang re-application at upload.
                                            </div>
                                        </div>
                                    @elseif(isset($application) && $application)
                                        <div class="info-card mb-0">
                                            <div class="ic-title" data-en="Your upload progress"
                                                data-tl="Progress ng iyong upload">Your upload progress</div>
                                            <div class="ic-body">{{ $approvedR }}/{{ $totalR }} approved — {{ $pctR }}%
                                                complete</div>
                                            <div
                                                style="height:8px;background:#dbe4ff;border-radius:4px;margin-top:10px;overflow:hidden;">
                                                <div
                                                    style="width:{{ $pctR }}%;height:100%;background:var(--primary-blue);border-radius:4px;">
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                        <div class="info-card mb-0">
                                            <div class="ic-title" data-en="Getting Started" data-tl="Pagsisimula">Getting
                                                Started</div>
                                            <div class="ic-body"
                                                data-en="Use the Next button below to begin. You can upload documents and track your application progress at any time."
                                                data-tl="Gamitin ang Next button sa ibaba para magsimula. Maaari kang mag-upload ng dokumento at subaybayan ang progress anumang oras.">
                                                Use the Next button below to begin. You can upload documents and track your
                                                application progress at any time.</div>
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="wizard-panel" data-panel="guide">
                            <div class="panel-heading" data-en="How to Avail a PWD ID"
                                data-tl="Paano Makuha ang PWD ID">How to Avail a PWD ID</div>
                            <div class="panel-sub"
                                data-en="Follow these 5 official steps to complete your PWD ID application."
                                data-tl="Sundin ang 5 opisyal na hakbang na ito para makumpleto ang iyong PWD ID application.">
                                Follow these 5 official steps to complete your PWD ID application.</div>

                            <div class="guide-steps-grid">
                                <div class="step-item">
                                    <div class="step-num">1</div>
                                    <div class="step-content">
                                        <div class="step-title" data-en="Visit the Official PWD Website"
                                            data-tl="Bisitahin ang Opisyal na PWD Website">Visit the Official PWD
                                            Website</div>
                                        <div class="step-desc"
                                            data-en="Go to the DOH PWD portal to access all official forms and information."
                                            data-tl="Pumunta sa DOH PWD portal para ma-access ang lahat ng opisyal na forms at impormasyon.">
                                            Go to the DOH PWD portal to access all official forms and information.</div>
                                        <a href="https://pwd.doh.gov.ph" target="_blank"
                                            class="step-link mt-2 d-block">https://pwd.doh.gov.ph</a>
                                    </div>
                                </div>
                                ...
                                <div class="step-item">
                                    ...
                                    <div class="step-content">
                                        <div class="step-title" data-en="Download the Application Form"
                                            data-tl="I-download ang Application Form">Download the Application Form
                                        </div>
                                        <div class="step-desc"
                                            data-en="Go to the Downloads section and download the official PRPWD Application Form. You may fill it out digitally or print it."
                                            data-tl="Pumunta sa Downloads section at i-download ang opisyal na PRPWD Application Form. Maaari mo itong punan nang digital o i-print.">
                                            Go to the Downloads section and download the official PRPWD Application
                                            Form. You may fill it out digitally or print it.</div>
                                    </div>
                                </div>
                                <div class="connector"></div>
                                <div class="step-item">
                                    ...
                                    <div class="step-content">
                                        <div class="step-title"
                                            data-en="Fill Out & Submit with Certificate of Disability"
                                            data-tl="Punan at Isumite kasama ang Sertipiko ng Kapansanan">Fill Out &
                                            Submit with Certificate of Disability</div>
                                        <div class="step-desc"
                                            data-en="Complete all required fields, then upload the completed form along with your Certificate of Disability to the official website."
                                            data-tl="Kumpletuhin ang lahat ng kinakailangang fields, pagkatapos ay i-upload ang nakumpletong form kasama ang iyong Sertipiko ng Kapansanan sa opisyal na website.">
                                            Complete all required fields, then upload the completed form along with your
                                            Certificate of Disability to the official website.</div>
                                        <div class="step-note">
                                            <strong>Note:</strong>
                                            <span
                                                data-en="You may also personally submit your documents at the MSWDO Office (Municipal Hall, Ground Floor) for faster processing."
                                                data-tl="Maaari ka ring personal na isumite ang iyong mga dokumento sa opisina ng MSWDO (Municipal Hall, Ground Floor) para mas mabilis na maproseso.">You
                                                may also personally submit your documents at the MSWDO Office (Municipal
                                                Hall, Ground Floor) for faster processing.</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="connector"></div>
                                <div class="step-item">
                                    ...
                                    <div class="step-content">
                                        <div class="step-title" data-en="Submit Two (2) 1×1 ID Pictures to MSWDO"
                                            data-tl="Isumite ang Dalawang (2) 1×1 ID na Larawan sa MSWDO">Submit Two (2)
                                            1×1 ID Pictures to MSWDO</div>
                                        <div class="step-desc"
                                            data-en="Once your application is approved online, bring two (2) recent 1×1 ID pictures to the MSWDO office."
                                            data-tl="Kapag naaprubahan na ang iyong aplikasyon online, magdala ng dalawang (2) bagong 1×1 ID na larawan sa opisina ng MSWDO.">
                                            Once your application is approved online, bring two (2) recent 1×1 ID
                                            pictures to the MSWDO office.</div>
                                    </div>
                                </div>
                                <div class="connector"></div>
                                <div class="step-item">
                                    ...
                                    <div class="step-content">
                                        <div class="step-title" data-en="Wait for Your Physical PWD ID"
                                            data-tl="Hintayin ang Iyong Pisikal na PWD ID">Wait for Your Physical PWD ID
                                        </div>
                                        <div class="step-desc"
                                            data-en="The MSWDO will process your physical PWD ID. You will be notified once it is ready for release."
                                            data-tl="Ipoproseso ng MSWDO ang iyong pisikal na PWD ID. Maabisuhan ka kapag handa na itong makuha.">
                                            The MSWDO will process your physical PWD ID. You will be notified once it is
                                            ready for release.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wizard-panel" data-panel="resources">
                            <div class="panel-heading" data-en="Download Form & MSWDO Office"
                                data-tl="I-download ang Form at Opisina ng MSWDO">Download Form & MSWDO Office</div>
                            <div class="panel-sub"
                                data-en="Get the official PRPWD form and know where to submit your requirements in person."
                                data-tl="Kunin ang opisyal na PRPWD form at alamin kung saan isusumite ang mga kinakailangan nang personal.">
                                Get the official PRPWD form and know where to submit your requirements in person.</div>

                            <div class="info-card mb-4">
                                <div class="ic-title" data-en="What you will download"
                                    data-tl="Ano ang iyong ma-download">What you will download</div>
                                <div class="ic-body"
                                    data-en="The official Persons with Disability (PWD) ID application form (PRPWD form) recognized by all LGUs in the Philippines."
                                    data-tl="Ang opisyal na Application Form para sa Persons with Disability (PWD) ID (PRPWD form)  kinikilala ng lahat ng LGU sa Pilipinas.">
                                    The official Persons with Disability (PWD) ID application form (PRPWD form)
                                    recognized by all LGUs in the Philippines.</div>
                            </div>

                            <div class="row g-3 mb-4">
                                <div class="col-md-6 col-lg-4">
                                    <a href="https://pwd.doh.gov.ph/downloads/PRPWD-APPLICATION_FORM.pdf"
                                        target="_blank" class="btn-yellow w-100">
                                        <span data-en="Download PRPWD Form (PDF)"
                                            data-tl="I-download ang PRPWD Form (PDF)">Download PRPWD Form (PDF)</span>
                                    </a>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <a href="https://pwd.doh.gov.ph" target="_blank" class="btn-blue w-100">
                                        <span data-en="Visit Official PWD Portal"
                                            data-tl="Bisitahin ang Opisyal na PWD Portal">Visit Official PWD
                                            Portal</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="resources-grid">
                                <div>
                                    <div class="info-card">
                                        <div class="ic-title" data-en="MSWDO Office Location"
                                            data-tl="Lokasyon ng Opisina ng MSWDO">MSWDO Office Location</div>
                                        <div class="ic-body"
                                    ...
                                    <div class="info-card">
                                        <div class="ic-title" data-en="Office Hours" data-tl="Oras ng Opisina">Office
                                            Hours</div>
                                        <div class="ic-body"
                                            data-en="Monday – Friday, 8:00 AM – 5:00 PM (Closed on Holidays)"
                                            data-tl="Lunes – Biyernes, 8:00 AM – 5:00 PM (Sarado sa mga Pista Opisyal)">
                                            Monday – Friday, 8:00 AM – 5:00 PM <small style="color:#94a3b8;">(Closed on
                                                Holidays)</small></div>
                                    </div>
                                </div>
                                <div class="info-card yellow mb-0">
                                    <div class="ic-title" data-en="What to Bring" data-tl="Mga Dapat Dalhin">What to
                                        Bring</div>
                                    <div class="ic-body">
                                        <ul style="margin:0;padding-left:18px;line-height:2;">
                                            <li data-en="Completed PRPWD Application Form"
                        ...
                        <div class="wizard-panel" data-panel="verify">
                            <div class="panel-heading" data-en="Verify PWD Membership"
                                data-tl="I-verify ang PWD Membership">Verify PWD Membership</div>
                            <div class="panel-sub"
                                data-en="Check your PWD registration status using the official DOH verification portal."
                                data-tl="Suriin ang iyong katayuan ng PWD registration gamit ang opisyal na DOH verification portal.">
                                Check your PWD registration status using the official DOH verification portal.</div>
                            ...
                            <div class="verify-grid">
                                <div>
                                    <div class="step-item">
                                        <div class="step-num">1</div>
                                        <div class="step-content">
                                            <div class="step-title" data-en="Visit the Verification Page"
                                                data-tl="Bisitahin ang Verification Page">Visit the Verification Page
                                            </div>
                                            <div class="step-desc"
                                                data-en="Open the official PWD ID verification portal using the button below."
                                                data-tl="Buksan ang opisyal na PWD ID verification portal gamit ang button sa ibaba.">
                                                Open the official PWD ID verification portal using the button below.
                                            </div>
                                            <a href="https://pwd.doh.gov.ph/tbl_pwd_id_verificationlist.php"
                                                target="_blank"
                                                class="step-link mt-2 d-block">pwd.doh.gov.ph/tbl_pwd_id_verificationlist.php</a>
                                        </div>
                                    </div>
                                    <div class="connector"></div>
                                    <div class="step-item">
                                        <div class="step-num">2</div>
                                        <div class="step-content">
                                            <div class="step-title" data-en="Locate the Verification Section"
                                                data-tl="Hanapin ang Verification Section">Locate the Verification
                                                Section</div>
                                            <div class="step-desc"
                                                data-en="On the verification page, find the search box where you can enter your PWD details."
                                                data-tl="Sa verification page, hanapin ang search box kung saan maaari kang maglagay ng iyong PWD details.">
                                                On the verification page, find the search box where you can enter your
                                                PWD details.</div>
                                        </div>
                                    </div>
                                    <div class="connector"></div>
                                    <div class="step-item">
                                        <div class="step-num">3</div>
                                        <div class="step-content">
                                            <div class="step-title" data-en="Enter PWD ID Number or Full Name"
                                                data-tl="Ilagay ang PWD ID Number o Buong Pangalan">Enter PWD ID Number
                                                or Full Name</div>
                                            <div class="step-desc"
                                                data-en="Type your 16-digit PWD ID number (XXXX-XXXX-XXXX-XXXX) or your full registered name."
                                                data-tl="I-type ang iyong 16-digit na PWD ID number (XXXX-XXXX-XXXX-XXXX) o ang iyong buong nakarehistrong pangalan.">
                                ...
                                <div>
                                    <div class="info-card mb-3">
                                        <div class="ic-title" data-en="Search by PWD ID Number"
                                            data-tl="Maghanap gamit ang PWD ID Number">Search by PWD ID Number</div>
                                        <div class="ic-body" data-en="Enter your complete 16-digit PWD ID number."
                                            data-tl="Ilagay ang inyong kumpletong 16-digit na PWD ID number.">Enter your
                                            complete 16-digit PWD ID number.</div>
                                    </div>
                                    <div class="info-card mb-3">
                                        <div class="ic-title" data-en="Search by Full Name"
                                            data-tl="Maghanap gamit ang Buong Pangalan">Search by Full Name</div>
                                        <div class="ic-body"
                                            data-en="Enter the full registered name exactly as written on the application form."
                                            data-tl="Ilagay ang buong nakarehistrong pangalan nang eksakto tulad ng nakasulat sa application form.">
                                            Enter the full registered name exactly as written on the application form.
                                        </div>
                                    </div>
                                    <div class="info-card yellow mb-3">
                                        <div class="ic-title" data-en="Privacy & Security"
                                            data-tl="Privacy at Seguridad">Privacy & Security</div>
                                        <div class="ic-body"
                                            data-en="The verification portal is hosted by the Department of Health (DOH). MSWDO does not receive or store any information you enter there."
                                            data-tl="Ang verification portal ay ino-host ng Department of Health (DOH). Hindi tinatanggap o iniimbak ng MSWDO ang anumang impormasyon na iyong inilalagay doon.">
                                            The verification portal is hosted by the Department of Health (DOH). MSWDO
                                            does not receive or store any information you enter there.</div>
                                    </div>

                                    <div class="cta-strip">
                                        <div>
                                            <div class="cta-text-main" data-en="Ready to verify your PWD membership?"
                                                data-tl="Handa na bang i-verify ang iyong PWD membership?">Ready to
                                                verify your PWD membership?</div>
                                            <div class="cta-text-sub"
                                                data-en="Opens the official DOH portal in a new tab."
                                                data-tl="Magbubukas ng opisyal na DOH portal sa bagong tab.">Opens the
                                                official DOH portal in a new tab.</div>
                                        </div>
                                        <a href="https://pwd.doh.gov.ph/tbl_pwd_id_verificationlist.php" target="_blank"
                                            ...
                                            <span data-en="Open Verifier" data-tl="Buksan ang Verifier">Open
                                                Verifier</span>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="wizard-nav">
                        ...
                        <button type="button" class="wiz-btn-next wiz-btn-finish" id="wiz-btn-finish"
                            onclick="finishWizard()">
                            <span data-en="Finish & Track Application" data-tl="Tapusin at Subaybayan">Finish & Track
                                Application</span> ✓
                        </button>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content" style="border-radius:20px;overflow:hidden;border:none;">
                <div class="modal-header"
                    style="background:var(--primary-gradient);color:white;border:none;padding:20px 24px;">
                    <h5 class="modal-title" id="fileViewerModalLabel" style="font-weight:800;font-size:1.2rem;">Document
                        Viewer</h5>
                ...
                <div class="modal-body" style="padding:24px;">
                    <div id="fileViewerContainer"
                        style="text-align:center;background:var(--bg-light);border-radius:12px;padding:24px;min-height:400px;display:flex;align-items:center;justify-content:center;">
                        <div class="text-muted">Loading document...</div>
                    </div>
                    <div id="fileInfo"
                        style="margin-top:20px;padding-top:16px;border-top:1px solid var(--border-light);"></div>
                </div>
                <div class="modal-footer" style="background:var(--bg-light);border:none;padding:16px 24px;">
                    ...
                    <a href="#" id="downloadFileBtn" class="btn btn-primary" download
                        style="background:var(--primary-blue);border:none;border-radius:8px;font-weight:600;">Download
                        File</a>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function showWizardView() {
            ...
            const heroTitle = document.getElementById('hero-title');
            const heroSub = document.getElementById('hero-sub');
            heroTitle.dataset.en = 'PWD Application';
            heroTitle.dataset.tl = 'PWD Application';
