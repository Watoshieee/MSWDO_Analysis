            ...
            <div class="pwd-req {{ $cls }}">
                ...
                @if(!$uf || $fStatus === 'rejected')
                    <div class="pwd-upload-box">
                        ...
                        <input type="file" class="req-file form-control form-control-sm" data-req="{{ $reqName }}"
...
<div id="inline-upload-wrap-{{ $uploadPrefix }}"
    style="display:none;margin-top:18px;background:#EEF2FF;border:1.5px solid #A0B6E8;border-radius:12px;padding:14px 18px;">
    <div style="display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap;">
        <div style="flex:1;min-width:0;">
            <div id="inline-label-{{ $uploadPrefix }}" style="font-weight:800;color:#2C3E8F;font-size:.88rem;">0 files
                selected</div>
            <div style="margin-top:6px;height:5px;background:#dbe4ff;border-radius:3px;overflow:hidden;">
                <div id="inline-bar-{{ $uploadPrefix }}"
                    style="height:100%;width:0%;background:#2C3E8F;border-radius:3px;transition:width .3s;"></div>
            </div>
