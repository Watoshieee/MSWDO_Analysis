...
<div class="container py-4" style="flex:1;">
    ...
    <div class="sec-card">
        ...
        <div class="sec-body">
            <form id="aicsBurialBatch" action="{{ route('user.aics-burial-upload-batch') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                ...
                <div style="margin-top:20px;display:flex;align-items:center;gap:14px;flex-wrap:wrap;">
                    <button type="submit" id="aicsBurialBatch-btn" class="upload-all-btn">
