                    ...
                    <div class="upload-box">
                        ...
                        <form action="{{ route('user.aics-burial-upload') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-1 align-items-center">
                                <div class="col-8">
                                    <input type="file" name="file" class="form-control form-control-sm" accept=".jpg,.jpeg,.png,.pdf" onchange="validateAicsBurialFile(this)" required>
...
<script>
function validateAicsBurialFile(input) {
