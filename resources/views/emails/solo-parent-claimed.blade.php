...
<head>
    ...
    <title>Solo Parent ID Claimed</title>
    <style>
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <div class="message">
            This is your official confirmation that your <strong>Solo Parent ID</strong> has been
            successfully claimed at the <strong>{{ $application->municipality }} MSWDO Office</strong>.
            Congratulations and welcome to the Solo Parent program!
        </div>
