...
<head>
    ...
    <title>PWD Requirements Validated</title>
    <style>
        ...
        .box { background: #eef2ff; border-left: 4px solid #2C3E8F; border-radius: 10px; padding: 14px 16px; font-size: .86rem; line-height: 1.6; margin-bottom: 20px; }
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <div class="msg">
                Your submitted requirements for <strong>PWD ID</strong> have been validated by MSWDO.
                Please wait for a follow-up notification when your physical ID is ready for pick-up.
            </div>
            <div class="box">
                <strong>Application #{{ $application->id }}</strong><br>
                Municipality: {{ $application->municipality }}<br>
                Status: Validated<br>
                Validated at: {{ now()->setTimezone('Asia/Manila')->format('M d, Y h:i A') }}
            </div>
