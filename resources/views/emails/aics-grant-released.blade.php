...
<head>
    ...
    <title>AICS Grant Released</title>
    <style>
        ...
        .header { background: linear-gradient(135deg, #16a34a 0%, #064e3b 100%); padding: 40px 32px 32px; text-align: center; }
        ...
        .info-card { background: linear-gradient(135deg, #f0fff4, #dcfce7); border-left: 4px solid #16a34a; border-radius: 12px; padding: 20px 22px; margin-bottom: 24px; }
        .info-card h3 { color: #15803d; font-size: .85rem; font-weight: 800; text-transform: uppercase; letter-spacing: .06em; margin: 0 0 12px; }
        .info-row { display: flex; gap: 10px; align-items: flex-start; margin-bottom: 8px; font-size: .88rem; color: #334155; }
        .info-row span:first-child { font-weight: 700; min-width: 100px; color: #1e293b; }
        .highlight-box { background: #f0fdf4; border: 1.5px solid #86efac; border-radius: 12px; padding: 16px 20px; margin-bottom: 24px; font-size: .88rem; color: #14532d; line-height: 1.6; }
        .highlight-box strong { display: block; margin-bottom: 6px; font-size: .92rem; color: #166534; }
        .cta-block { text-align: center; margin: 28px 0 24px; }
        .cta-btn { display: inline-block; background: linear-gradient(135deg, #16a34a, #064e3b); color: white; text-decoration: none; border-radius: 12px; padding: 14px 36px; font-weight: 800; font-size: .95rem; letter-spacing: .02em; }
...
<div class="wrapper">
    ...
    <div class="header">
        ...
        @endphp
        <h1>{{ $programLabel }} Grant Released!</h1>
    ...
    <div class="body">
        ...
        <div class="message">
            This is your official confirmation that your <strong>{{ $programLabel }}</strong> grant
            has been successfully released at the <strong>{{ $application->municipality }} MSWDO Office</strong>.
            We hope this assistance helps you and your family.
        </div>
        ...
        <div class="info-card">
            ...
            <div class="info-row">
                ...
                <span>{{ \Carbon\Carbon::now()->format('F d, Y \a\t h:i A') }}</span>
            </div>
        </div>
        ...
        <div class="message" style="font-size:.84rem;color:#94a3b8;">
            If you have any questions, please contact your local MSWDO office directly.
        </div>
    </div>
