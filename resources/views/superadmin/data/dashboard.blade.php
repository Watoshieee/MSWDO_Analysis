...
<head>
    ...
    <style>
        ...
        *,body{font-family:'Inter','Segoe UI',sans-serif;}
        ...
        .menu-card{background:white;border-radius:18px;padding:32px 26px;border:1px solid var(--border-light);box-shadow:0 4px 15px rgba(0,0,0,.03);transition:all .3s ease;height:100%;cursor:pointer;text-decoration:none;display:block;position:relative;overflow:hidden;}
        .menu-card::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;background:var(--secondary-gradient);}
        .menu-card:hover{transform:translateY(-5px);box-shadow:0 14px 32px rgba(44,62,143,.12);border-color:var(--primary-blue-soft);}
        .menu-card-num{font-size:.75rem;font-weight:800;color:rgba(253,185,19,.8);letter-spacing:.15em;text-transform:uppercase;margin-bottom:10px;}
        .menu-card-title{font-size:1.15rem;font-weight:800;color:var(--primary-blue);margin-bottom:6px;}
        .menu-card-desc{font-size:.85rem;color:#64748b;line-height:1.6;}
        .menu-card-arrow{position:absolute;bottom:22px;right:22px;font-size:1.2rem;color:var(--secondary-yellow);font-weight:900;transition:transform .25s ease;}
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <a href="{{ route('superadmin.data.municipalities') }}" class="menu-card">
                        ...
                        <div class="menu-card-desc">Update population by gender, age groups, households and demographics for each municipality.</div>
                ...
                <div class="col-md-4">
                    <a href="{{ route('superadmin.data.barangays') }}" class="menu-card">
                        ...
                        <div class="menu-card-desc">Manage barangay-level household counts and population statistics per municipality.</div>
                        <span class="menu-card-arrow">&#8594;</span>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('superadmin.data.programs') }}" class="menu-card">
                        ...
                        <div class="menu-card-desc">Track beneficiary counts per social welfare program across each municipality.</div>
                        <span class="menu-card-arrow">&#8594;</span>
                    </a>
                </div>
            </div>
