...
<head>
    ...
    <title>Barangay Data - Super Admin</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="bi bi-grid-3x3"></i> Barangay Data Management
            </a>
    ...
    <div class="container mt-4">
        <h1 style="color: var(--primary-blue);" class="mb-4">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="year" class="form-select" required>
                                                    @foreach(range(date('Y') - 2, date('Y') + 1) as $yearOption)
                                                        <option value="{{ $yearOption }}" {{ ($barangay->year ?? date('Y')) == $yearOption ? 'selected' : '' }}>
                                                            {{ $yearOption }}
                                                        </option>
                                                    @endforeach
                                                </select>
