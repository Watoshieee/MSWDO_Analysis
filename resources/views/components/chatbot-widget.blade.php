...
#mswdo-bot-wrap *{box-sizing:border-box;}
...
#mswdo-bot-toggle svg { width:28px; height:28px; fill:white; }
...
#mswdo-bot-badge.hidden { display:none; }
...
.bot-header-avatar svg { width:22px; height:22px; fill:#FDB913; }
.bot-header-info { flex:1; }
.bot-header-name  { color:#fff; font-weight:800; font-size:0.95rem; letter-spacing:0.01em; }
.bot-header-sub   { color:rgba(255,255,255,0.65); font-size:0.72rem; font-weight:500; margin-top:1px; }
.bot-status-dot   { width:8px; height:8px; border-radius:50%; background:#28a745; display:inline-block; margin-right:5px; animation:statusPulse 2s ease-in-out infinite; }
...
#mswdo-bot-close:hover { background: rgba(255,255,255,0.25); }
...
.bot-chip:hover { background:#2C3E8F; color:white; border-color:#2C3E8F; }
...
#mswdo-bot-messages::-webkit-scrollbar { width:4px; }
#mswdo-bot-messages::-webkit-scrollbar-track { background:transparent; }
#mswdo-bot-messages::-webkit-scrollbar-thumb { background:#cbd5e1; border-radius:4px; }
...
.bot-msg-avatar svg { width:14px; height:14px; fill:white; }
.bot-msg-avatar.user-av {
    background: linear-gradient(135deg,#FDB913,#E5A500);
}
.bot-msg-avatar.user-av svg { fill:#1A2A5C; }
.bot-bubble {
    max-width: 78%;
    padding: 10px 14px;
    border-radius: 18px;
...
.bot-bubble a { color:inherit; text-decoration:underline; }
/* Markdown-like formatting inside bubbles */
.bot-bubble strong { font-weight:700; }
.bot-bubble ul,.bot-bubble ol { margin:6px 0 0 0; padding:0; list-style:none; }
...
#mswdo-bot-typing.show { display:flex; }
.typing-dots {
    background: #f0f5ff;
    border-radius: 18px;
    border-bottom-left-radius: 4px;
...
#mswdo-bot-input:focus { border-color:#2C3E8F; background:#fff; }
#mswdo-bot-input::placeholder { color:#94a3b8; }
#mswdo-bot-send {
...
#mswdo-bot-send:hover { transform:scale(1.1); box-shadow:0 4px 14px rgba(44,62,143,0.35); }
#mswdo-bot-send:disabled { opacity:0.45; cursor:not-allowed; transform:none; }
#mswdo-bot-send svg { width:16px; height:16px; fill:white; }
...
@media(max-width:480px){
    #mswdo-bot-panel { width:calc(100vw - 20px); right:10px; bottom:90px; }
    #mswdo-bot-toggle { right:16px; bottom:16px; }
}
</style>
...
<div id="mswdo-bot-wrap">
    ...
    <button id="mswdo-bot-toggle" onclick="msBot.toggle()" title="MSWDO AI Assistant" aria-label="Open MSWDO chatbot">
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2C6.477 2 2 6.477 2 12c0 1.82.487 3.53 1.338 5.007L2.07 21.19a1 1 0 001.24 1.24l4.183-1.268A9.953 9.953 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm-1 13H7v-2h4v2zm6 0h-4v-2h4v2zm0-4H7V9h10v2z"/>
        </svg>
    ...
    <div id="mswdo-bot-panel" role="dialog" aria-label="MSWDO AI Chatbot">
        ...
        <div id="mswdo-bot-header">
            ...
            <div class="bot-header-info">
                ...
                <div class="bot-header-sub"><span class="bot-status-dot"></span>Online · Powered by Gemini AI</div>
            </div>
        ...
        <div id="mswdo-bot-input-area">
            <textarea id="mswdo-bot-input"
                placeholder="Magtanong o humingi ng tulong..."
                rows="1"
                aria-label="Chat message"
                onkeydown="msBot.onKey(event)"></textarea>
